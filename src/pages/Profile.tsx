...
import { Loader2, Zap, Trophy, BookOpen } from "lucide-react";
          ...
          <div className="px-6 pb-6 -mt-12">
            <div className="flex items-end gap-4">
              ...
              <div className="flex-1 mb-1">
                ...
                <p className="text-sm text-primary font-semibold">Level {computedLevel} • {profile.xp.toLocaleString()} XP</p>
